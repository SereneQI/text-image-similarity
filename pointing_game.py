...
from dataset.dataset import VgCaptions
from utils.localization import compute_pointing_game_acc
from models.model import joint_embedding
from utils.utils import collate_fn_img_padded, collate_fn_cap_padded
